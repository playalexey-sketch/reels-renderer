...
**Правило коммитов (согласовано с пользователем):** пушатся ТОЛЬКО версии,
которые пользователь подтвердил как рабочие/лучшие (команда вида «сохраняй»,
«уже лучше»). Экспериментальные итерации живут локально до одобрения.
Подтверждённые вехи помечаются тегами (`working-v1`, …) и релизами.
